               ...
               <div class="cmr1">
                  ...
                  <div class="form-group col-md-12 paddiv" >
                     ...
                     <div class="col-md-6">
                        ...
                        <input id="value" name="value" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?=isset($data->value)?$data->value:''; ?>" placeholder="{{__('messages.value')}}">
                     </div>
                  </div>
                  <div class="form-group col-md-12 paddiv">
                     <div class="col-md-6">
               ...
               <div class="cmr1">
                  <div class="form-group col-md-12 paddiv">
                     ...
                     <div class="col-md-6">
                        ...
                        <input id="maximum_spend" name="maximum_spend" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?=isset($data->maximum_spend)?$data->maximum_spend:''; ?>" placeholder="{{__('messages.maximum_spend')}}" onkeypress="return isNumberKey(event)">
                     </div>
                  </div>
                  <div class="form-group col-md-12">
                     <div class="form-check">
